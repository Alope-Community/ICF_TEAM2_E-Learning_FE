      ...
      <div className="container">
        <div className="flex flex-wrap ml-10">
          <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
            <h2 className="font-bold text-4xl text-white mb-5"><span className="font-bold text-cyan-500">E-</span>Lope</h2>
            <h3 className="font-bold text-xl mb-2">Tentang Kami</h3>
            <p className="text-sm">Sebuah platform pembelajaran online yang dirancang dengan baik untuk memastikan setiap orang bisa belajar bahasa pemograman secara efektif,kapan pun, di mana pun mereka mau.</p>
